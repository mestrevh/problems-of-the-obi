...
def check_input(finput, **kwargs):
	...
	for i in xrange(0, n):
		...
		x = get_integer(tokens[0], 0, kwargs["XY"])
		y = get_integer(tokens[1], 0, kwargs["XY"])
	...
	if ini_times != sorted(ini_times):
		error('init times must be given sorted')
...
if __name__ == "__main__":
	...
	for j in range(1, 5):
		...
		for i in range(1,101):
			...
			check_input_output(inp, outp, i, N = 10000, XY = 1000)
	...
	for j in range(5, 11):
		...
		for i in range(1,101):
			...
			check_input_output(inp, outp, i, N = 10000, XY = 1000000)
